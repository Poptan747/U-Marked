...
class _lecturerListState extends State<lecturerList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: lecturerListAppBar(context),
      body: SafeArea(
        child: Container(
                    ...
                    if (searchQuery.isNotEmpty) {
                      filteredDocs = docs.where((doc) {
                        ...
                        return data['name'].toLowerCase().contains(searchQuery.toLowerCase()) ||
                            data['lecturerID'].toLowerCase().contains(searchQuery.toLowerCase());
                      }).toList();
                    } else {
                                    ...
                                    showModalBottomSheet(
                                      ...
                                      builder: (BuildContext context) {
                                        return Padding(
                                          ...
                                          child: editLecturerBottomSheet(uid: documentID),
                                        );
                                      },
                                    );
                                  }
